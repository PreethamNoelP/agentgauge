...
- **Honest about its limits.** Every heuristic's blind spots are documented in [RULES.md](RULES.md) — including the ones that are embarrassing. A governance tool that hides its own blind spots would fail its own audit.
